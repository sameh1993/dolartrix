  ...
  <section class="demo section-padding-100-70" id="demo">
    <div class="container">
      <div class="section-heading text-center">
        <h2 class="wow fadeInUp" data-wow-delay="0.3s">Inner Pages</h2>
        <p class="wow fadeInUp" data-wow-delay="0.4s">
          Our Template will be a perfect platform for presenting You future
          Template. This Landing Page comes in clean design
        </p>
      </div>
      <div class="row">
        <div
          class="col-lg-4 col-md-6 col-sm-12"
          v-for="(item, index) in getDemo"
          :key="index"
        >
          <div class="demo-item">
...
export default {
  data() {
    return {
      innerPage: this.$store.state.demosList,
    };
  },
  computed: {
    getDemo() {
      return this.innerPage.slice(2, 8);
    },
  },
};
</script>